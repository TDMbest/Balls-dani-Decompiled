	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = uint3(tmp0.xyz) & uint3(float3(Infinity, Infinity, Infinity));
                tmp1.xyz = tmp1.xyz != int3(2139095040, 2139095040, 2139095040);
                tmp0.w = tmp1.y ? tmp1.x : 0.0;
                tmp0.w = tmp1.z ? tmp0.w : 0.0;
                o.sv_target.xyz = tmp0.www ? tmp0.xyz : 0.0;
                return o;
			}
			ENDCG
		}
