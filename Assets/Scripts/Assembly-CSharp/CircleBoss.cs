...
public class CircleBoss : MonoBehaviour
{
	...
	public static CircleBoss Instance { get; set; }
	...
	private void KillBoss()
	{
		...
		float num = 1000000 * (bossNr + 1);
		Score.Instance.AddScore(num);
