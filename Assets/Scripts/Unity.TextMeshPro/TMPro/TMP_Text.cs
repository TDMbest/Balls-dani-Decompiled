	...
	public abstract class TMP_Text : MaskableGraphic
	{
		...
		protected void GetSpecialCharacters(TMP_FontAsset fontAsset)
		{
			if (!fontAsset.characterLookupTable.TryGetValue(95u, out m_cached_Underline_Character))
			{
				...
				TMP_FontAsset fontAsset2;
				m_cached_Underline_Character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(95u, fontAsset, false, m_FontStyleInternal, m_FontWeightInternal, out isAlternativeTypeface, out fontAsset2);
			...
			{
				bool isAlternativeTypeface2;
				TMP_FontAsset fontAsset3;
				m_cached_Ellipsis_Character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(8230u, fontAsset, false, m_FontStyleInternal, m_FontWeightInternal, out isAlternativeTypeface2, out fontAsset3);
		...
		protected bool ValidateHtmlTag(UnicodeChar[] chars, int startIndex, out int endIndex)
		{
			...
			case 2246877:
			{
				...
				for (int l = 0; l < m_xmlAttribute.Length && m_xmlAttribute[l].nameHashCode != 0; l++)
				{
					...
					case 30547:
					case 43347:
						m_currentSpriteAsset = TMP_SpriteAsset.SearchForSpriteByHashCode(m_currentSpriteAsset, m_xmlAttribute[l].valueHashCode, true, out spriteIndex);
						if (spriteIndex == -1)
						{
							return false;
						}
