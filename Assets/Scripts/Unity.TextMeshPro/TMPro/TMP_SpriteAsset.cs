	...
	public class TMP_SpriteAsset : TMP_Asset
	{
		...
		public void UpdateLookupTables()
		{
			...
			for (int j = 0; j < m_SpriteCharacterTable.Count; j++)
			{
				...
				int value;
				if (m_GlyphIndexLookup.TryGetValue(glyphIndex, out value))
				{
		...
		public void SortGlyphTable()
		{
			...
			{
				m_SpriteGlyphTable = Enumerable.ToList(Enumerable.OrderBy(m_SpriteGlyphTable, (TMP_SpriteGlyph item) => item.index));
			}
		}
		...
		internal void SortCharacterTable()
		{
			...
			{
				m_SpriteCharacterTable = Enumerable.ToList(Enumerable.OrderBy(m_SpriteCharacterTable, (TMP_SpriteCharacter c) => c.unicode));
			}
		}
